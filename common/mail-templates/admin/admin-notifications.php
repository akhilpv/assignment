                  ...
                  <tr>
                    <td>
                      <table width="566" align="center" bgcolor="#ffffff" style="padding: 35px 42px;">
                        ...
                        <tr>
                          <td style="font-size: 14px; font-weight: 400; color: #000000; line-height: 22px;"><?=(!empty($params['mailContent']) ? $params['mailContent'] : $params['message']) ?></td>
                        </tr>
                        <tr>
                          <td height="5"></td>
                        </tr>
                        ...
                        ?>
                        <tr>
                          <td style="font-size: 14px; font-weight: 400; color: #000000; line-height: 22px;">Click <?=Html::a('here',$params['link'])?> to find more details about it. </td>
                        </tr>
                        <?php } ?>
